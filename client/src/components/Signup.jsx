  ...
  return (
    <>
      <div className="flex h-screen items-center justify-center">
        <div className="">
          <div className="modal-box w-fit bg-white dark:bg-gray-800 text-gray-800 dark:text-white">
            <form onSubmit={handleSubmit(onSubmit)} method="dialog">
              ...
              <div className="mt-4 space-y-2">
                ...
                <input
                  ...
                  className="w-80 px-3 py-1 border rounded-md outline-none dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              ...
              {/* Button */}
              <div className="flex justify-around px-4 gap-2 mt-6">
